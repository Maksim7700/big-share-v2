...
const Leader = ({src, title, name, link}) => {
    return (
        <div className="leader">
            <img className='leader-img' src={src} alt="Leader" loading="lazy"/>
            <div className='leader-info'>
                <div>
                    <div className="leader-title">{title}</div>
                    <div className="leader-name">{name}</div>
                </div>
                <div className='leader-linkedin'>
                    <div className='linkedin'><a href={link} target='_black'>
