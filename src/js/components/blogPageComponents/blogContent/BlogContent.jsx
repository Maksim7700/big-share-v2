...
export const BlogContent = () => {
    ...
    return (
        ...
        <div className="email-subscribe">
            <Container>
                <div className="email-subscribe-container">
                    <div className="email-subsctibe-logo">
                    ...
                    <div className="email-subscribe-inform">
                        <div className="email-subscribe-inform-data">
                            <div className="email-subscribe-inform-title">Come on, subscribe to our blog!</div>
                            <div className="email-subscribe-inform-text">Stay updated on the latest announcements and  updates</div>
                        </div>
                        <div className="email-subscribe-form">
                            <form className="subsctiption-form" action="">
                                <input placeholder="Enter email address" className="subsctiption-input" type="text" />
        ...
        <Content openMore={openMore} blogs={blogs?.data} size={3} requestStatus={blogs.requestStatus} totalElements={blogs.totalElements} />
        </>
    );
}
