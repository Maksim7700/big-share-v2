    ...
    return (
        <div className='admin-container'>
            <div className='left-side'>
                <div className='image-bighsare'><img id='image' src="./head/big_share_header_logo.svg"
                                                     alt='bigshare'/></div>
            </div>
                    ...
                    <div className='forma'>
                        ...
                        <form className="my-login-validation" onSubmit={handleSubmit} noValidate={false}>
                            <div className='login-input'>
                                ...
                                <input placeholder='Username' id="login" type="text" className='form-login' minLength={5}
                                       value={values.username} onChange={handleChange} name="username" required/>
                            </div>

                            <div className='password-input'>
                                <label className='password'>Password</label>
                                <input placeholder='Password' id="password" type="password" className="form-login" minLength={4}
